...
- **The clients that actually churn have a lower age compared to the clients that renew their subscription**. This insight is actually quite intuitive since the younger population are more likely to be financially dependent and make less money than the older clients.
- The new clients are more likely to churn compared to loyal customers. This means that the company should focus its efforts in coming up with incentives to keep the new clients.
